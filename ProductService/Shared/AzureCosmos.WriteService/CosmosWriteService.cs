namespace AzureCosmos.WriteService
{
    ...
    public class CosmosWriteService : IWriteService
    {
        ...
        public CosmosWriteService(IConfiguration configuration, string connectionSring, string cosmosDatabaseId,
            string containerName, ILogger<CosmosWriteService> logger)
        {
